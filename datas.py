...
with st.form("new_log_form"):
    ...
    if submitted:
        ...
        st.markdown(f"""
            🛑🚗 A {driver_age}-year-old {driver_gender} driver was stopped for {predicted_violation} at {stop_time}. {search_text} and they recieved a {predicted_outcome}. The stop lasted {stop_duration} minutes and was {drug_text}.
        """)
